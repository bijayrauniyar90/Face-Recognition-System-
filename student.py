...
class Student:
    def __init__(self, root):
        ...
        img_left = Image.open(
            r"C:\Users\KIIT01\Face Recognition System\image\handsup.jpeg")
        ...
        radiobtn2 = ttk.Radiobutton(
            Class_Student_course_frame, variable=self.var_radio2, text="No Photo Sample", value="No")
        ...
        # update button
        update_btn = Button(btn_frame, text="Update", width=18, font=(
            "times new roman", 13, "bold"), bg="blue", fg="white")
        ...
        # reset button
        reset_btn = Button(btn_frame, text="Reset", width=19, font=(
            "times new roman", 13, "bold"), bg="blue", fg="white")
        ...
        # Take a photo sample
        take_photo_btn = Button(btn_frame1, text="Take photo sample", width=38, font=(
            "times new roman", 13, "bold"), bg="blue", fg="white")
        ...
        img_right = Image.open(
            r"C:\Users\KIIT01\Face Recognition System\image\student.jpg")
