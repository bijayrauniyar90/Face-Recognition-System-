...
class Student:
    def __init__(self,root):
        ...
        #Top img 
        img = Image.open(r"C:\Users\KIIT01\Face Recognition System\images\img11.jpg")
        ...
        # Put Top Image as a single or Add below all three Images
        ...
        studentID_entry=ttk.Entry(Class_Student_course_frame, textvariable=self.var_stu_id, width=20,font=("times new roman", 13, "bold"))
        ...
        studentName_entry=ttk.Entry(Class_Student_course_frame, textvariable=self.var_stu_name, width=20,font=("times new roman", 13, "bold"))
        ...
        class_div_entry=ttk.Entry(Class_Student_course_frame,textvariable=self.var_div, width=20,font=("times new roman", 13, "bold"))
        ...
        roll_no_entry=ttk.Entry(Class_Student_course_frame, textvariable=self.var_roll,  width=20,font=("times new roman", 13, "bold"))
        ...
        gender_entry=ttk.Entry(Class_Student_course_frame, textvariable=self.var_gender, width=20,font=("times new roman", 13, "bold"))
        ...
        dob_entry=ttk.Entry(Class_Student_course_frame, textvariable=self.var_dob, width=20,font=("times new roman", 13, "bold"))
        ...
        email_entry=ttk.Entry(Class_Student_course_frame, textvariable=self.var_email,  width=20,font=("times new roman", 13, "bold"))
        ...
        phone_no_entry=ttk.Entry(Class_Student_course_frame, textvariable=self.var_phone, width=20,font=("times new roman", 13, "bold"))
        ...
        addressentry=ttk.Entry(Class_Student_course_frame, textvariable=self.var_address, width=20,font=("times new roman", 13, "bold"))
        ...
        teacher_entry=ttk.Entry(Class_Student_course_frame,textvariable=self.var_teacher, width=20,font=("times new roman", 13, "bold"))
        teacher_entry.grid(row=4,column=3,padx=10, pady=5, sticky=W)

        # radio buttons
        self.var_radio1=StringVar()
        radiobtn1=ttk.Radiobutton(Class_Student_course_frame,textvariable=self.var_radio1,text="Take Photo Sample", value="Yes")
        radiobtn1.grid(row=5, column=0)

        self.var_radio2=StringVar()
        radiobtn2=ttk.Radiobutton(Class_Student_course_frame, textvariable=self.var_radio2, text="No Photo Sample", value="No")
        ...
        # Save button
        save_btn=Button(btn_frame, text="Save", command=self.add_date,width=19,font=("times new roman", 13, "bold"),bg="blue", fg="white")
